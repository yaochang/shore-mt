...
public:
    ...
    rc_t fill_page(std::vector<cvec_t*>& keys, std::vector<lpid_t>& subroots);    
...
public:
    ...
    static rc_t create(const stid_t stid, lpid_t& pid, std::vector<cvec_t*>& keys, std::vector<lpid_t>& subroots);
